...
if __name__ == '__main__':
    ...
    sys.stdout = open('DDL_command_cnn_ps2_w2_trace_resource_RTX3090.sh', 'w')
    python_path = "/root/anaconda3/envs/tfbuild/bin/python3.6"
    result_path = "/home/xsailor4/cyshin/benchmarks/xonar_results/"
    nvml_path = "/home/xsailor4/cyshin/benchmarks/NVML_jh"
    ...
    for key, value in cifar10_command_dict.items():
        ...
        print("mv /home/xsailor4/cyshin/benchmarks/*.json", result_dir + "/")
        print("mv /home/xsailor4/cyshin//benchmarks/*.pbtxt", result_dir + "/")
