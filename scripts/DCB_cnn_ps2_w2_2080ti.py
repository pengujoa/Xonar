...
def cnn_model_name_builder():
    ...
    _imagenet_command_dict.pop('imagenet_vgg16_async_batch256')
    _imagenet_command_dict.pop('imagenet_vgg19_sync_batch256')
    _imagenet_command_dict.pop('imagenet_vgg19_sync_batch128')
    _imagenet_command_dict.pop('imagenet_inception4_sync_optMomentum')
    _imagenet_command_dict.pop('imagenet_vgg11_sync_batch128')
    _imagenet_command_dict.pop('imagenet_vgg16_async_batch128')
    _cifar10_command_dict.pop('cifar10_densenet100_k12_sync_batch256')
    _imagenet_command_dict.pop('imagenet_googlenet_sync_batch512')
    _imagenet_command_dict.pop('imagenet_resnet152_v2_sync_batch128')
    _imagenet_command_dict.pop('imagenet_inception4_sync_xla')
    _cifar10_command_dict.pop('cifar10_densenet100_k24_async_batch128')
    _imagenet_command_dict.pop('imagenet_vgg16_async_optMomentum')
    _imagenet_command_dict.pop('imagenet_resnet50_v2_async_batch256')
    _imagenet_command_dict.pop('imagenet_resnet50_v2_sync_batch256')
    _imagenet_command_dict.pop('imagenet_resnet101_v2_async_batch128')
    _imagenet_command_dict.pop('imagenet_inception3_sync_batch128')
    _imagenet_command_dict.pop('imagenet_inception4_sync_optRmsprop')
    _imagenet_command_dict.pop('imagenet_vgg11_async_batch128')
    _imagenet_command_dict.pop('imagenet_vgg16_sync_batch128')
    _imagenet_command_dict.pop('imagenet_googlenet_async_batch512')
    _imagenet_command_dict.pop('imagenet_vgg19_async_batch128')
    _imagenet_command_dict.pop('imagenet_vgg11_async_batch256')
    _imagenet_command_dict.pop('imagenet_resnet101_sync_batch128')
    _imagenet_command_dict.pop('imagenet_resnet152_v2_async_winograd')
    _imagenet_command_dict.pop('imagenet_resnet50_async_batch256')
    _imagenet_command_dict.pop('imagenet_vgg11_sync_batch256')
    _cifar10_command_dict.pop('cifar10_densenet100_k12_async_batch256')
    _imagenet_command_dict.pop('imagenet_inception4_sync_winograd')
    _imagenet_command_dict.pop('imagenet_resnet50_v2_sync_batch128')
    _imagenet_command_dict.pop('imagenet_resnet152_async_optRmsprop')
    _imagenet_command_dict.pop('imagenet_resnet152_async_batch64')
    _imagenet_command_dict.pop('imagenet_vgg19_async_batch256')
    _imagenet_command_dict.pop('imagenet_resnet50_sync_batch128')
    _cifar10_command_dict.pop('cifar10_densenet100_k24_sync_batch128')
    _imagenet_command_dict.pop('imagenet_resnet101_v2_sync_batch128')
    _imagenet_command_dict.pop('imagenet_inception3_sync_batch256')
    _imagenet_command_dict.pop('imagenet_resnet152_sync_dataFormat')
    _imagenet_command_dict.pop('imagenet_resnet152_v2_sync_xla')
    _imagenet_command_dict.pop('imagenet_inception4_async_batch64')
    _imagenet_command_dict.pop('imagenet_vgg16_sync_batch256')
    _imagenet_command_dict.pop('imagenet_resnet50_async_batch128')
    _imagenet_command_dict.pop('imagenet_resnet152_v2_sync_winograd')
    _imagenet_command_dict.pop('imagenet_resnet152_v2_sync_optMomentum')
...
if __name__ == '__main__':
    ...
    sys.stdout = open('DDL_command_cnn_ps2_w2_trace_resource_2080ti.sh', 'w')
    python_path = "/root/anaconda3/envs/tfbuild/bin/python3.6"
    result_path = "/home/xsailor2/cyshin/benchmarks/xonar_results/"
    nvml_path = "/home/xsailor2/cyshin/benchmarks/NVML_jh"
    ...
    for key, value in cifar10_command_dict.items():
        ...
        print("mv /home/xsailor2/cyshin/benchmarks/*.json", result_dir + "/")
        print("mv /home/xsailor2/cyshin//benchmarks/*.pbtxt", result_dir + "/")
