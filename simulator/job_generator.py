...
def random_job():
    ...
    CIFAR10_model_list = ["densenet40_k12", "densenet100_k12", "densenet100_k24",
    ...
    Params_list = ["batch32", "batch64", "batch128", "batch256", "batch512", "use_fp16", "optMomentum", "optRmsprop", "dataFormat",
                   "winograd", "xla"]
...
def generate_scripts():
    ...
    oom_model_list = ['cifar10_densenet100_k12_sync_batch512', 'cifar10_densenet100_k12_async_batch512',
                      ...
                      'imagenet_resnet50_v2_sync_batch512', 'imagenet_resnet50_v2_async_batch512',
                      'imagenet_resnet101_sync_batch256', 'imagenet_resnet101_async_batch256',
                      'imagenet_resnet101_v2_sync_batch256', 'imagenet_resnet101_v2_async_batch256',
                      'imagenet_resnet101_sync_batch512', 'imagenet_resnet101_async_batch512',
                      'imagenet_resnet101_v2_sync_batch512', 'imagenet_resnet101_v2_async_batch512',
                      'imagenet_resnet152_sync_batch256', 'imagenet_resnet152_async_batch256',
                      'imagenet_resnet152_v2_sync_batch256', 'imagenet_resnet152_v2_async_batch256',
                      'imagenet_resnet152_sync_batch512', 'imagenet_resnet152_async_batch512',
                      'imagenet_resnet152_v2_sync_batch512', 'imagenet_resnet152_v2_async_batch512',
    ...
    command.append(
        ...
        + "--model=" + option["model"] + " --data_name=" + option["dataset"] + " --num_batches=10 --display_every=1 &")
    command.append(
    ...
    print("a=`ps -ef | grep 'job_name=worker --task_index=0' | awk '{print $2}' | sed -n '1p'`;", file=script_file)
    print("b=`ps -ef | grep 'job_name=worker --task_index=0' | awk '{print $2}' | sed -n '2p'`;", file=script_file)
    print("c=`ps -ef | grep 'job_name=worker --task_index=1' | awk '{print $2}' | sed -n '1p'`;", file=script_file)
    print("d=`ps -ef | grep 'job_name=worker --task_index=1' | awk '{print $2}' | sed -n '2p'`;", file=script_file)
